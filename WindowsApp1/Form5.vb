...
Public Class Form5
    ...
    Private Sub InsertCustomerButton_Click(sender As Object, e As EventArgs) Handles InsertCustomerButton.Click
        Try
            Using connection As New MySqlConnection(connectionString)
                connection.Open()
                    ...
                    If SelectedCarPartIDs IsNot Nothing AndAlso SelectedCarPartIDs.Count > 0 Then
                        Using CONNECT As New MySqlConnection(connectionString)
                            ...
                            For Each partID As Integer In SelectedCarPartIDs
                                ...
                                Dim partCmd As New MySqlCommand(partSQL, CONNECT)
